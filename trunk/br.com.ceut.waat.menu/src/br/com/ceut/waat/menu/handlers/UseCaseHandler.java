...
public class UseCaseHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (saved) {
			...
			String xml = ScenarioInterpreter.getInstance().parseToXML(fileContent);
			
			File XMLFile = WaatEngineFacade.createXMLUseCaseFile(xml);
			WaatEngineFacade.generateTest(XMLFile);
