 ...
 * 
 */
public class GlossaryInterpreter {
	...
	public String parseToXML(String input) {
		...
		try {
			GlossaryLexer lexer = new GlossaryLexer(new ANTLRStringStream(
					input));
			CommonTokenStream tokens = new CommonTokenStream(lexer);
			GlossaryParser parser = new GlossaryParser(tokens);
			parser.glossary();
	...
	public static GlossaryInterpreter getInstance() {
		return new GlossaryInterpreter();
	}
}
